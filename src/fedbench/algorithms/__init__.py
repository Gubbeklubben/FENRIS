...
def register_builtin_algorithms(registry: FactoryRegistry[Algorithm]) -> None:
    ...
    registry.add_builtin("fed_tab_diff", f"{__package__}.fedtabdiff:FedTabDiff")
    registry.add_builtin("fed_tgan", f"{__package__}.fed_tgan:FedTGAN")
    registry.add_builtin("fed_random", f"{__package__}.fed_random:FedRandom")
