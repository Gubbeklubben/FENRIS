...
class Coordinator(Component):
    ...
    `fenris.core.payload.Payload`. This payload is used as input when
    ...
    def attach_global_init_artifacts(self, artifacts: Payload) -> None:
        ...
        artifacts : Payload
            ...
            `fenris.core.algorithm.synthesizer.GlobalInitArtifacts` instance
...
class SingleStepCoordinator(Coordinator):
    ...
    def aggregate_train(self, replies: Iterable[tuple[int, Payload]]) -> None:
        ...
        Parameters
        ----------
        replies : Iterable[tuple[int, `fenris.core.payload.Payload`]]
