...
from fenris.builtins.synthesizers.fedtabdiff.diffuser import Diffuser
from fenris.builtins.synthesizers.fedtabdiff.mlpsynthesizer import MLPSynthesizer
...
class FedTabDiff(Synthesizer):
    ...
    def train(self, request: Payload, df: DataFrame, context: TrainContext) -> Payload:
        ...
        # Adapt unsupervised FENRIS training to orig alg loop
